...
import { customerQuote } from "@/data/customerQuotesData"
...
export default function CustomerQuotesCard({ quote_text, author_name, author_post }: customerQuote) {
    return (
        <div className={styles.quotes_block_quotes_item}>
            ...
            <div className={styles.quotes_block_author}>
                ...
                <div className={styles.quotes_block_author_inside}>
                  <p className={styles.quotes_block_author_name}>{author_name}</p>
                  <p className={styles.quotes_block_author_post}>{author_post}</p>
                </div>
            </div>
        </div>
        // <div className={styles.quotes_block_quotes_item}>
